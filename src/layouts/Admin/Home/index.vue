<template>
  <div class="container">
    ...
    <a-card class="card" title="文章数据" :bordered="false">
      ...
      <a-row :gutter="12">
        <a-col :span="8">
          <a-card class="card" title="文章分类统计">
            <div class="pie-box">
    ...
    <a-card class="card" title="网站状态" :bordered="false">
      <a-row :gutter="12" class="link-status-wrapper">
        ...
        <a-col :span="16">
          <a-card class="card" title="最近友链申请">
      ...
      <a-row :gutter="12">
        ...
        <a-col :span="8">
          <a-card class="card" title="最近发表心情">
            <a href="#" slot="extra">更多</a>
            <a-table
